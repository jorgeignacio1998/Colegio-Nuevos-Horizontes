    ...
    .l7{
        ...
        top: -7rem;
                    ...
                    <li class="list__item matriculas l1">
                        <div class="list__button">
                            <a href="index.php"  class="nav__link" >   <i class="fa-solid fa-book-bookmark">  </i> &nbsp; &nbsp;Matriculas  </a >
                        </div>
                    </li>
                    <!-- Matriculas -->
                    ...
                    <li class="list__item apoderados l6">
                        <div class="list__button">
                            <a href="../asignaturas/index.php"  class="nav__link" >   <i class="fa-solid fa-book-bookmark">  </i> &nbsp; &nbsp;Asignaturas  </a >
                        </div>
                    </li>
                    <!-- Gestionar Asignaturas -->

                    <!-- Gestionar salas -->
                    <li class="list__item apoderados l7">
                        <div class="list__button">
                            <a href="../salas/index.php"  class="nav__link" >   <i class="fa-solid fa-book-bookmark">  </i> &nbsp; &nbsp;Salas  </a >
                        </div>
                    </li>
                    <!-- Gestionar salas -->
