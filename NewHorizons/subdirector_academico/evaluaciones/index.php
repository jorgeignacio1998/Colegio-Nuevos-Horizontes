                                        ...
                                        <table class="table align-middle">
                                                ...
                                                <tbody >
                                                    ...
                                                    <tr >
                                                        ...
                                                        <td><a class="text-primary" href="editar.php?id_eva=<?php echo $fila['evaid']; ?>&grado=<?php echo $id_grado; ?>">        <i class="bi bi-pencil-square boton"></i></a>  </td>
                                                        <td><a onclick="return confirm('¿estas seguro que quieres desvincular al alumno del curso?')" class="text-danger" href="c_eliminar.php?id_eva=<?php echo $fila['evaid']; ?>&grado=<?php echo $id_grado; ?>">   <i class="bi bi-trash"></i></a>  </td>  
