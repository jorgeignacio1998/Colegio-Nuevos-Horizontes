...
$datos_categorias = $mysqli->query("SELECT * FROM categorias "); //obtiene datos de todos los productos
    ...
    if(empty($input)){
        ...
        $query = "SELECT * FROM categorias WHERE NOMBRE LIKE '{$input}%'  ";   //OR ID LIKE '{$input}%' OR EMAIL LIKE '{$input}%' OR NIVEL LIKE '{$input}%'
        }
